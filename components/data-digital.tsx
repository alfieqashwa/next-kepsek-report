        ...
        <div className="my-5 py-8 -ml-[72px] -mr-6 md:-ml-20 md:-mr-8 px-24 bg-[#F9FFFF]">
            <section className="flex items-start justify-around">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="relative bg-[#2D9CDB] shadow-lg shadow-[#169859]/50 text-center shrink-0 flex justify-center items-center w-14 h-14 rounded-lg mt-8 -rotate-45">
